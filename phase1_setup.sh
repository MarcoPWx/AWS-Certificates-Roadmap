...
# Create Resources.md file with the specified format
cat <<EOL > Phases/Phase-1-Solutions-Architect-Associate/Resources.md
...
echo "Phase 1: AWS Solutions Architect Associate Resources.md created successfully!"
